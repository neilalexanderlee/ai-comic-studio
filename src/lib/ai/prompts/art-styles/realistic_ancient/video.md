...
| 模式 | 风格标签 |
|------|----------|
| **Seedance 2.0 通用（中文）** | `古风写实摄影，电影风格，强对比度，极致细节` |
| **通用多参模式（英文）** | `Chinese period drama, photorealistic, cinematic, high contrast, ultra-fine detail` |
| **首尾帧模式（英文）** | `Chinese period drama, photorealistic, cinematic, high contrast, ultra-fine detail, shallow depth of field` |

---

## 王家卫式古典调性（王家卫 / Christopher Doyle 摄影语言移植）

| 元素 | 标准词汇 |
|------|----------|
| 基础风格标签 | `王家卫式古典电影风格，35mm Kodak Vision3胶片颗粒，anamorphic widescreen 16:9` |
| 光影基调 | `暗调低key，大量阴影+局部烛光高光，冷蓝月色主导，contrast偏强` |
| 华丽宫廷变体 | `珠光金主色调，冷蓝侧月光，暖橘烛光点缀，medium contrast` |
...
| 场景氛围 | 推荐摄影机支撑 |
|---|---|
| 王家卫式室内静态（闺阁/密室/书房） | `三脚架完全固定（locked-off shot），画面无运动` |
| 庭院回廊穿行跟拍 | `手持晃动handheld camera，广角12mm，自然抖动` |
| 情感张力对话场景 | `手持轻微呼吸感（subtle handheld breathing movement）` |
| 一镜到底长廊跟拍 | `steady-cam稳定，持续匀速倒退跟拍` |
| 命运转折/高潮场景 | `handheld微抖，IMAX 65mm` |
...
- **caustics波光**：`[人物]脸上有缓慢流动的冷蓝色调波纹光斑（水面/湖面折射效果），脸是波光主要承载体`
- **空气尘埃**：`暖橘烛光下微尘漂浮可见，光柱穿过空气，粒子在光柱里清晰可见`

...
const transitionLabels: Record<string, string> = {
  ...
  "slide-left": "向左滑入", "slide-right": "向右滑入",
  "slide-up": "向上滑入", "slide-down": "向下滑入",
  "wipe-left": "向左擦除", "wipe-right": "向右擦除",
  "wipe-up": "向上擦除", "wipe-down": "向下擦除",
  "zoom-in": "放大进入", "zoom-out": "缩小进入",
  rotate: "旋转", circle: "圆形擦除",
  diamond: "菱形擦除", clock: "时钟擦除", blur: "模糊过渡",
};

export function getTransitionTypeName(type: string): string {
  return transitionLabels[type] ?? type;
}
